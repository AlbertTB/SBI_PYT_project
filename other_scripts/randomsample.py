...
dir1 = '../train_data/holo4k/receptor'          # Source folder (main files)
dir3 = '../train_data/holo4k/predictions'             # Folder with corresponding .csv files
...
print(f"Selected and copied {len(selected_files)} complete pairs (file, .csv).")
